...
namespace DnDGen.DungeonGen.Tests.Unit.Generators.ContentGenerators
{
    ...
    public class DomainContentsGeneratorTests
    {
        ...
        public void GenerateMinorFeatures()
        {
            ...
            var count = 1;
            mockPercentileSelector.Setup(s => s.SelectFrom(Config.Name, TableNameConstants.MinorFeatures)).Returns(() => $"minor feature {count++}");
        ...
        public void GenerateMajorFeatures()
        {
            ...
            var count = 1;
            mockPercentileSelector.Setup(s => s.SelectFrom(Config.Name, TableNameConstants.MajorFeatures)).Returns(() => $"major feature {count++}");
        ...
        public void CanHaveDuplicateFeatures()
        {
            ...
            mockPercentileSelector.Setup(s => s.SelectFrom(Config.Name, TableNameConstants.MinorFeatures)).Returns("minor feature");
            mockPercentileSelector.Setup(s => s.SelectFrom(Config.Name, TableNameConstants.MajorFeatures)).Returns("major feature");
        ...
        public void GenerateUncontainedTreasure()
        {
            ...
            mockPercentileSelector.Setup(s => s.SelectFrom(Config.Name, TableNameConstants.TreasureContainers)).Returns(string.Empty);
            mockPercentileSelector.Setup(s => s.SelectFrom(Config.Name, TableNameConstants.TreasureConcealment)).Returns(string.Empty);
        ...
        public void GenerateContainedTreasure()
        {
            ...
            mockPercentileSelector.Setup(s => s.SelectFrom(Config.Name, TableNameConstants.TreasureContainers)).Returns("container");
            mockPercentileSelector.Setup(s => s.SelectFrom(Config.Name, TableNameConstants.TreasureConcealment)).Returns(string.Empty);
        ...
        public void GenerateHiddenTreasure()
        {
            ...
            mockPercentileSelector.Setup(s => s.SelectFrom(Config.Name, TableNameConstants.TreasureContainers)).Returns(string.Empty);
            mockPercentileSelector.Setup(s => s.SelectFrom(Config.Name, TableNameConstants.TreasureConcealment)).Returns("peek-a-boo");
