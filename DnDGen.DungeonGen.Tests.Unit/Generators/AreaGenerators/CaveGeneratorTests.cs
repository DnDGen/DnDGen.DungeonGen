...
namespace DnDGen.DungeonGen.Tests.Unit.Generators.AreaGenerators
{
    ...
    public class CaveGeneratorTests
    {
        ...
        {
            selectedCave.Contents.Miscellaneous = [ContentsTypeConstants.Lake];

            mockPercentileSelector.Setup(s => s.SelectFrom(Config.Name, TableNameConstants.Lakes)).Returns(string.Empty);
        ...
        public void GenerateCaveWithLake()
        {
            ...
            mockPercentileSelector.Setup(s => s.SelectFrom(Config.Name, TableNameConstants.Lakes)).Returns("laketown");
        ...
        public void GenerateCaveWithLakeAndEncounter()
        {
            ...
            mockPercentileSelector.Setup(s => s.SelectFrom(Config.Name, TableNameConstants.Lakes)).Returns("laketown/Encounter");
