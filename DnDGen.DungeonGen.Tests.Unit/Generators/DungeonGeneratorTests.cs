...
namespace DnDGen.DungeonGen.Tests.Unit.Generators
{
    [TestFixture]
    public class DungeonGeneratorTests
    {
        ...
        public void Setup()
        {
            ...
            dungeonGenerator = new DungeonGenerator(
                ...
                mockTrapGenerator.Object,
                mockPercentileSelector.Object,
                mockEncounterGenerator.Object);
        ...
        public void SetDoorLocationFromHall()
        {
            ...
            mockPercentileSelector.SetupSequence(s => s.SelectFrom(Config.Name, TableNameConstants.DoorLocations)).Returns("below").Returns("on the ceiling");
        ...
        public void DoorStraightAheadPreventsHallContinuing()
        {
            ...
            var door = new Area { Type = AreaTypeConstants.Door, Descriptions = ["description"] };
            ...
            mockAreaGenerator.SetupSequence(g => g.Generate(9266, specifications)).Returns(new[] { door }).Returns(new[] { otherDoor });
            mockPercentileSelector.SetupSequence(s => s.SelectFrom(Config.Name, TableNameConstants.DoorLocations)).Returns("below").Returns(DescriptionConstants.StraightAhead);
