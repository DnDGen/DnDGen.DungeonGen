...
namespace DnDGen.DungeonGen.Tests.Unit.Selectors
{
    [TestFixture]
    public class AreaPercentileSelectorTests
    {
        ...
        {
            mockInnerSelector.Setup(s => s.SelectFrom(Config.Name, "table name")).Returns("area type");
        ...
        {
            mockInnerSelector.Setup(s => s.SelectFrom(Config.Name, "table name")).Returns("area type(description)");
        ...
        {
            mockInnerSelector.Setup(s => s.SelectFrom(Config.Name, "table name")).Returns("area type(description/other description)");
        ...
        {
            mockInnerSelector.Setup(s => s.SelectFrom(Config.Name, "table name")).Returns("area type(description of 1d2 things/other description of 3d4 things)");
        ...
        {
            mockInnerSelector.Setup(s => s.SelectFrom(Config.Name, "table name")).Returns("area type{9266x0}");
        ...
        {
            mockInnerSelector.Setup(s => s.SelectFrom(Config.Name, "table name")).Returns("area type{0x90210}");
        ...
        {
            mockInnerSelector.Setup(s => s.SelectFrom(Config.Name, "table name")).Returns("area type[contents]");
        ...
        {
            mockInnerSelector.Setup(s => s.SelectFrom(Config.Name, "table name")).Returns("area type[contents/more contents/even more contents]");
        ...
        {
            mockInnerSelector.Setup(s => s.SelectFrom(Config.Name, "table name")).Returns("area type[42/600]");
        ...
        {
            mockInnerSelector.Setup(s => s.SelectFrom(Config.Name, "table name")).Returns("area type[42/600/even more contents]");
        ...
        public void ReturnFullAreaFromInnerSelector()
        {
            ...
            mockInnerSelector
                .Setup(s => s.SelectFrom(Config.Name, "table name"))
                .Returns("area type(description/other description)[contents/more contents/even more contents]{1d2x3d4}");
