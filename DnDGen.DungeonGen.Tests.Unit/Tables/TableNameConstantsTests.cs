...
namespace DnDGen.DungeonGen.Tests.Unit.Tables
{
    [TestFixture]
    public class TableNameConstantsTests
    {
        ...
        [TestCase(TableNameConstants.Lakes, "Lakes")]
        [TestCase(TableNameConstants.MagicPoolAlignments, "MagicPoolAlignments")]
        [TestCase(TableNameConstants.MagicPoolPowers, "MagicPoolPowers")]
        [TestCase(TableNameConstants.MagicPoolTeleportationDestinations, "MagicPoolTeleportationDestinations")]
        [TestCase(TableNameConstants.MajorFeatures, "MajorFeatures")]
        [TestCase(TableNameConstants.MinorFeatures, "MinorFeatures")]
        [TestCase(TableNameConstants.Pools, "Pools")]
